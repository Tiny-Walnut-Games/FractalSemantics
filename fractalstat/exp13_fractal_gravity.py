...
# Re-export the main experiment function for backward compatibility
def run_fractal_gravity_experiment(
    elements_to_test=None,
    population_size=5,  # Much smaller for hierarchical test
    interaction_samples=5000
):
    """
    Run EXP-13: Fractal Gravity Without Falloff (v2 - Pure Hierarchical)
    
    Backward compatibility wrapper that uses the new modular implementation.
