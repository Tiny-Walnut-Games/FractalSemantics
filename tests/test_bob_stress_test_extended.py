...
class TestBobStressTestExtended:
    ...
    async def test_single_query_with_mock_api(self):
        ...
        from fractalstat.bob_stress_test import (
            BobStressTester,
            NPCQueryGenerator,
        )
    ...
    def test_performance_degradation_detection(self):
        ...
        assert (
            report["performance_metrics"]["p95_query_time_ms"]
            > report["performance_metrics"]["median_query_time_ms"]
        )
    ...
    def test_bob_verdict_tracking(self):
        ...
        tester.results = (
            [{"bob_status": "PASSED"}] * 80
            + [{"bob_status": "VERIFIED"}] * 15
            + [{"bob_status": "QUARANTINED"}] * 5
        )
