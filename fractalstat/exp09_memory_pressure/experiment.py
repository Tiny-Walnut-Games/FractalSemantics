"""
EXP-09: FractalStat Performance Under Memory Pressure - Experiment Logic

This module contains the core experiment logic for memory pressure testing.
It implements the MemoryPressureTester class that manages memory pressure
testing, optimization strategies, and performance analysis, as well as the
MemoryPressureExperiment class that orchestrates the complete experiment
execution.
