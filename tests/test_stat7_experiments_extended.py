"""
Extended tests for STAT7 Experiments to achieve 95%+ coverage
...
class TestEXP03DimensionNecessity:
    ...
    def test_exp03_initialization(self):
        """EXP03_DimensionNecessity should initialize with sample size."""
        from fractalstat.stat7_experiments import EXP03_DimensionNecessity

        exp = EXP03_DimensionNecessity(sample_size=500)
...
class TestEXP03Result:
    ...
    def test_exp03_result_to_dict(self):
        ...
        assert not result_dict["acceptable"]
...
class TestEdgeCases:
    ...
    def test_stat7_uri_edge_cases(self):
        """get_stat7_uri should handle edge case coordinates."""
