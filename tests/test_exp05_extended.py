...
class TestExp05Extended:
    ...
    def test_save_results_with_file_io(self):
        ...
        from fractalstat.exp05_compression_expansion import save_results, CompressionExperimentResults
...
class TestExp05ExceptionHandling:
    ...
    def test_reconstruction_failure_handling(self):
        ...
        from fractalstat.exp05_compression_expansion import CompressionPipeline, BitChainCompressionPath
        from fractalstat.stat7_experiments import generate_random_bitchain, Coordinates
...
class TestExp05MainEntryPoint:
    ...
    def test_main_with_quick_mode(self):
        ...
        with patch.object(sys, 'argv', ['exp05_compression_expansion.py', '--quick']):
            results = run_compression_expansion_test(num_bitchains=20, show_samples=False)
...
class TestExp05EdgeCases:
    ...
    def test_compression_with_empty_adjacency(self):
        ...
        bc = BitChain(coordinates=coords)
...
class TestExp05BoundaryCases:
    ...
    def test_findings_generation_edge_cases(self):
        ...
        assert any("modest" in finding for finding in results_low_compression.major_findings)
