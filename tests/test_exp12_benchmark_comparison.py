...
from fractalsemantics.exp12_benchmark_comparison import (
...
class TestSystemBenchmarkResult:
    ...
    def test_initialization(self):
        ...
        assert result.system_name == "FractalSemantics"
...
class TestBenchmarkComparisonResult:
    ...
    def test_initialization(self):
        ...
        result = BenchmarkComparisonResult(
            ...
            scales_tested=[10000],
            num_queries=1000,
            systems_tested=["uuid", "fractalsemantics"],
            system_results=[],
            best_collision_rate_system="FractalSemantics",
            best_retrieval_latency_system="UUID",
            best_storage_efficiency_system="UUID",
            best_semantic_expressiveness_system="FractalSemantics",
            best_overall_system="FractalSemantics",
            fractalsemantics_rank_collision=1,
            fractalsemantics_rank_retrieval=2,
            fractalsemantics_rank_storage=3,
            fractalsemantics_rank_semantic=1,
            fractalsemantics_overall_score=0.85,
            major_findings=["FractalSemantics competitive"],
            fractalsemantics_competitive=True,
        )

        assert result.sample_size == 10000
        assert result.fractalsemantics_competitive
        assert result.best_overall_system == "FractalSemantics"
    ...
    def test_to_dict(self):
        ...
        assert result_dict["fractalsemantics_positioning"]["competitive"]
...
class TestBenchmarkSystems:
    ...
    def test_fractalsemantics_system(self):
        """FractalSemanticsSystem should use FractalSemantics addressing."""
        system = FractalSemanticsSystem()

        assert system.name == "FractalSemantics"
...
class TestBenchmarkComparisonExperiment:
    ...
    def test_initialization(self):
        ...
        exp = BenchmarkComparisonExperiment(
            sample_size=1000,
            benchmark_systems=["uuid", "fractalsemantics"],
            scales=[1000],
            num_queries=100,
        )

        assert exp.sample_size == 1000
        assert exp.benchmark_systems == ["uuid", "fractalsemantics"]
    ...
    def test_initialization_defaults(self):
        ...
        assert "fractalsemantics" in exp.benchmark_systems
    ...
    def test_create_system(self):
        ...
        fractalsemantics_sys = exp._create_system("fractalsemantics")
        assert isinstance(fractalsemantics_sys, FractalSemanticsSystem)
    ...
    def test_run_comparative_analysis(self):
        ...
        exp = BenchmarkComparisonExperiment(
            sample_size=100,
            benchmark_systems=["uuid", "sha256", "fractalsemantics"],
            scales=[100],
            num_queries=10,
        )
        ...
        assert result.best_collision_rate_system in ["UUID", "SHA256", "FractalSemantics"]
        ...
        assert result.best_overall_system in ["UUID", "SHA256", "FractalSemantics"]

    def test_run_fractalsemantics_rankings(self):
        """run() should calculate FractalSemantics rankings."""
        exp = BenchmarkComparisonExperiment(
            sample_size=100,
            benchmark_systems=["uuid", "sha256", "fractalsemantics"],
            scales=[100],
        ...
        # FractalSemantics should be ranked
        assert 1 <= result.fractalsemantics_rank_collision <= 3
        assert 1 <= result.fractalsemantics_rank_retrieval <= 3
        assert 1 <= result.fractalsemantics_rank_storage <= 3
        assert 1 <= result.fractalsemantics_rank_semantic <= 3
        assert 0.0 <= result.fractalsemantics_overall_score <= 1.0

    def test_run_fractalsemantics_competitive(self):
        """run() should evaluate if FractalSemantics is competitive."""
        exp = BenchmarkComparisonExperiment(
            sample_size=100,
            benchmark_systems=["uuid", "fractalsemantics"],
            scales=[100],
        ...
        assert isinstance(result.fractalsemantics_competitive, bool)
        # fractalsemantics_competitive may differ from overall success
        # success means experiment ran successfully,
        # fractalsemantics_competitive means FractalSemantics met strict criteria
        assert isinstance(success, bool)
    ...
    def test_run_major_findings(self):
        ...
        assert any("FractalSemantics" in f for f in result.major_findings)
...
class TestSaveResults:
    ...
    def test_save_results_custom_filename(self):
        ...
        result = BenchmarkComparisonResult(
            ...
            fractalsemantics_rank_collision=1,
            fractalsemantics_rank_retrieval=2,
            fractalsemantics_rank_storage=2,
            fractalsemantics_rank_semantic=1,
            fractalsemantics_overall_score=0.85,
            major_findings=[],
            fractalsemantics_competitive=True,
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with patch("fractalsemantics.exp12_benchmark_comparison.Path") as mock_path:
...
class TestEdgeCases:
    ...
    def test_single_system(self):
        ...
        exp = BenchmarkComparisonExperiment(
            sample_size=50,
            benchmark_systems=["fractalsemantics"],
            scales=[50],
            num_queries=5,
        )
        ...
        assert result.system_results[0].system_name == "FractalSemantics"
