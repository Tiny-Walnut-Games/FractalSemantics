"""
FractalSemantics Feature Flags and Experiment Configuration
...
class ExperimentConfig:
    ...
    Environment is determined by FRACTALSEMANTICS_ENV environment variable.
    ...
    def _merge_configs(self, override_config: dict[str, any]) -> None:
        ...
        if "experiments" in override_config:
            ...
            if "enabled" in override_config["experiments"]:
                self.config["experiments"]["enabled"] = override_config["experiments"][
                    "enabled"
                ]
...
_config_instance: Optional[ExperimentConfig] = None
