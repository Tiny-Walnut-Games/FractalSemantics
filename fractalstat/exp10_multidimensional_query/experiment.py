"""
EXP-10: Multi-Dimensional Query Optimization - Experiment Logic

This module contains the core experiment logic for multi-dimensional query optimization.
It implements the MultiDimensionalQueryEngine class that manages query execution,
optimization strategies, and performance analysis, as well as the
MultiDimensionalQueryExperiment class that orchestrates the complete experiment
execution.

Classes:
- MultiDimensionalQueryEngine: Query engine for FractalStat multi-dimensional queries
