"""
EXP-18: Falloff Injection in Thermodynamics - Experiment Logic

This module contains the core experiment logic for testing whether applying the same
falloff formula used in gravity to thermodynamic measurements makes fractal thermodynamics
behave more like classical thermodynamics.
...
# from .entities import ()
    # No entities needed for EXP-18, uses ThermodynamicState from EXP-17
