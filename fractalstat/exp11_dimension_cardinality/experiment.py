"""
EXP-11: Dimension Cardinality Analysis - Experiment Logic

This module contains the core experiment logic for dimension cardinality analysis.
It implements the EXP11_DimensionCardinality class that tests FractalStat addressing
with different dimension counts, measuring collision rates, retrieval performance,
storage efficiency, and semantic expressiveness.

Classes:
- EXP11_DimensionCardinality: Main experiment runner for dimension cardinality analysis
"""
...
# ============================================================================
# DIMENSION CARDINALITY EXPERIMENT
# ============================================================================


class EXP11_DimensionCardinality:
    """
    Tests FractalStat addressing with different dimension counts.
